...
export class ProfileEstadisticasComponent implements AfterViewInit{
    ...
    participatedBids = DATA_USER.participatedBids;
    wonBids = DATA_USER.wonBids;
    createdBids = DATA_USER.createdBids;
    participatedDraws = DATA_USER.participatedDraws;
    wonDraws = DATA_USER.wonDraws;
    createdDraws = DATA_USER.createdDraws;
